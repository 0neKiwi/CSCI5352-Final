...
def get_grown_bipartite_2(args):
    p, n, n2 = args
    g = ig.Graph()
    p1 = n/(n+n2)
    type1 = []
...
def get_grown_bipartite_2_lcc(args):
    p, n, n2 = args
    g = ig.Graph()
    p1 = n/(n+n2)
    type1 = []
...
def get_grown_bipartite_2_dist(args):
    p, n, n2 = args
    g = ig.Graph()
    p1 = n/(n+n2)
    type1 = []
...
if __name__ == "__main__":
    ...
    with mp.Pool(processes=10) as pool:
        iters = [(i, n, n) for i in np.linspace(0,2/(n+n),200)]
        for _ in range(1):
            results.append(pool.map(get_grown_bipartite_2_lcc, iters))
